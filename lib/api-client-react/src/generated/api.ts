 ...
 */
export const generateApp = async (generateAppInput: GenerateAppInput, options?: RequestInit): Promise<GenerateAppOutput> => {

  return customFetch<GenerateAppOutput>(getGenerateAppUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGenerateAppMutationOptions = <TError = ErrorType<GenerateError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateApp>>, TError,{data: BodyType<GenerateAppInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateApp>>, TError,{data: BodyType<GenerateAppInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateApp>>, {data: BodyType<GenerateAppInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateAppMutationResult = NonNullable<Awaited<ReturnType<typeof generateApp>>>
    export type GenerateAppMutationBody = BodyType<GenerateAppInput>
    export type GenerateAppMutationError = ErrorType<GenerateError>

    /**
 * @summary Generate application plan from an idea
 */
export const useGenerateApp = <TError = ErrorType<GenerateError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateApp>>, TError,{data: BodyType<GenerateAppInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof generateApp>>,
        TError,
        {data: BodyType<GenerateAppInput>},
        TContext
      > => {
